...
void CommandParser::registerNewUser()
{
	...
	cout<<"Please enter password(minimum 6 symbols):";
	cin>>pass;
	...
	string securityCode,securityCodeRight="a";
	//gen_random(securityCodeRight);
	server->sendEmail(user,securityCodeRight);
...
void CommandParser::loggedUserMenu(string user)
{
	...
	switch(choice)
	{
		case 1: system("clear");cout<<endl;server->clients[user]->printUnreadMessages();cout<<endl;break;
		case 2: system("clear");cout<<endl;server->clients[user]->printAndProceedFriendRequests();cout<<endl;break;
		case 3: system("clear");cout<<endl;server->clients[user]->printAndProceeInvitationsForEvents();cout<<endl;break;
		case 4: system("clear");cout<<endl;server->clients[user]->printAllMessages();cout<<endl;break;
		case 5: 
		{	
			system("clear");
			cout<<endl;
			...
			cin>>message;
			server->clients[user]->sendMessage(recipient,message);cout<<endl;break;
		}
		case 6: 
		{	
			system("clear");
			...
			cin>>to;
			server->clients[user]->sendFriendRequest(to);cout<<endl;break;
		}
		case 7: system("clear");cout<<endl;server->clients[user]->printMyFriends();cout<<endl;break;
		case 8: 
		{
			system("clear");
			cout<<endl;
			...
			cin>>location;
			server->clients[user]->hostEvent(name,date,time,location);cout<<endl;break;
		}
		case 9: 
		{
			system("clear");
			...
			cin>>guest;
			server->clients[user]->inviteForEvent(name,guest);cout<<endl;break;
		}
		case 10: 
		{
			system("clear");
			...
			server->clients[user]->printPotentialFriends();cout<<endl;break;
		}
		case 11:
		{	
			system("clear");
			...
			server->clients[user]->printPotentialEvents();cout<<endl;break;
		}
		case 12:system("clear");cout<<endl;accountOptions(user);cout<<endl;break;
		case 13:system("clear");cout<<endl;mainMenu();cout<<endl;break;
		default:system("clear");cout<<endl<<"Wrong command please select number between 1 and 12!"<<endl;break;
	}
	loggedUserMenu(user);
}
